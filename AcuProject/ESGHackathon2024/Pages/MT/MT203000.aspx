        ...
        <Levels>
            <px:PXGridLevel DataMember="Records">
                <RowTemplate>
                    ...
                    <px:PXMaskEdit ID="edIncidentTypeID" runat="server" DataField="IncidentTypeID" InputMask="&gt;aa" />
                    <px:PXTextEdit ID="edDescription" runat="server" DataField="Description" />
					<px:PXSelector ID="edNumberingID" runat="server" DataField="NumberingID" AllowEdit="True" />
                </RowTemplate>
                <Columns>
                    <px:PXGridColumn DataField="IncidentTypeID" DisplayFormat="&gt;aa" Width="100px" />
